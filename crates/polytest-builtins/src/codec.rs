use polytest_plugin_api::{Codec, PluginError, Result};
use polytest_protocol::{Event, MsgType, TestStatus, PTWP_MAGIC, PTWP_VERSION};

/// Human-readable line codec (`POLYTEST_MINIMAL_PRINT` compatible).
