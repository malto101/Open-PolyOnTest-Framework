...
3. Streams PolyTest **COBS/PTWP** frames via **ARM semihosting** (QEMU stderr)
...
Firmware is **~1.7 KB** text with `POLYTEST_FREESTANDING` (no newlib).
