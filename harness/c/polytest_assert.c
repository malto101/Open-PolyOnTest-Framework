/**
 * PolyTest Core — assertion implementations
...
static void pt_as_fail_msg(const char *file, int line, const char *base,
    ...
    (void)at;
    polytest_fail_at(file, line, buf);
}
...
void polytest_assert_int(int64_t expected, int64_t actual, int size, int is_hex,
...
#endif /* POLYTEST_CFG_HAS_EXTENDED_ASSERTS */
